...
<title>处理我的订单寻菜单名</title>
	...
	String sql1="select MenuName,UserName,Tel,Address,OrderCount,OrderPrice,OrderSum,OrderDate,OrderPost  from Orders,Menu,Users where Orders.MenuId=Menu.MenuId and Orders.UserId=Users.UserId and Users.UserId=? and MenuName like ?" ;
	ResultSet rs=DBHelper.executeQuery(conn1, sql1,session.getAttribute("UserId"),"%"+menuname+"%");
	while (rs.next()){
%>
			<tr align="center">
