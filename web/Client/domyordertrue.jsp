...
<title>处理我的订单已派送</title>
	...
	<body>
		...
		<form action="domyorderfindmenu.jsp" method="post" >
			<tr>
				...
				<td colspan="2"><input type="text" name="datetime"/>
	...
	String sql3="select MenuName,UserName,Tel,Address,OrderCount,OrderPrice,OrderSum,OrderDate,OrderPost  from Orders,Menu,Users where Orders.MenuId=Menu.MenuId and Orders.UserId=Users.UserId and Users.UserId=? and OrderPost=1 " ;
	ResultSet rs=DBHelper.executeQuery(conn3, sql3,session.getAttribute("UserId"));
	while (rs.next()){
%>
			<tr align="center">
