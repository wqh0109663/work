...
<title>处理我的订未派送</title>
	...
	String sql2="select MenuName,UserName,Tel,Address,OrderCount,OrderPrice,OrderSum,OrderDate,OrderPost  from Orders,Menu,Users where Orders.MenuId=Menu.MenuId and Orders.UserId=Users.UserId and Users.UserId=? and OrderPost=0 " ;
	ResultSet rs=DBHelper.executeQuery(conn2, sql2,session.getAttribute("UserId"));
